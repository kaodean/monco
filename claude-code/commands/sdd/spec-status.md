...
- Spec directory: !`ls -la .sdd/specs/$1/`
- Spec metadata: `.sdd/specs/$1/spec.json`
- Requirements: `.sdd/specs/$1/requirements.md`
- Design: `.sdd/specs/$1/design.md`
- Tasks: `.sdd/specs/$1/tasks.md`

### All Specs Overview

- Available specs: !`ls -la .sdd/specs/`
- Active specs: !`find .sdd/specs/ -name "spec.json" -exec grep -l "implementation_ready.*true" {} \;`

## Task: Generate Status Report

Create comprehensive status report for the specification in the language specified in spec.json (check `.sdd/specs/$1/spec.json` for "language" field):
